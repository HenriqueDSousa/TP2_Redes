...
class Frame:
    ...
    def from_bytes(data):
        ...
        sync_pattern1, sync_pattern2, length, frame_id, flags = struct.unpack('>8s8sHHBB', data[:Frame.HEADER_SIZE])
...
def main():
    ...
    while True:
        ...
        if received_frame.frame_id != last_received_frame_id and received_frame.checksum == Frame.compute_checksum(received_frame.data):
